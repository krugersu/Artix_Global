...
\sphinxAtStartPar
\sphinxurl{https://docs.artix.su/pages/viewpage.action?pageId=27530876}

\sphinxAtStartPar
\sphinxcode{\sphinxupquote{Добавление группы сертификатов со сроком действия через REST API}}
...
\phantomsection\label{\detokenize{setting:grammar-token-try_stmt}}\production{try\_stmt}{ try1\_stmt | try2\_stmt}
\phantomsection\label{\detokenize{setting:grammar-token-try1_stmt}}\production{try1\_stmt}{ "try" ":" \sphinxcode{\sphinxupquote{suite}}}
...
\phantomsection\label{\detokenize{setting:grammar-token-try2_stmt}}\production{try2\_stmt}{ "try" ":" \sphinxcode{\sphinxupquote{suite}}}
\productioncont{ "finally" ":" \sphinxcode{\sphinxupquote{suite}}}
\end{productionlist}
...
\noindent\sphinxincludegraphics{{set}.png}
\end{figure}
...
\sphinxAtStartPar
Логин: administrator
Пароль: \sphinxhref{mailto:adm@\#747911ART}{adm@\#747911ART}
...
\sphinxAtStartPar
This is my answer, taken from \sphinxhref{http://stackoverflow.com/a/33797841/322283}{StackOverflow}
You can use Markdown and reStructuredText in the same Sphinx project.
How to do this is succinctly documented in the \sphinxhref{https://www.sphinx-doc.org/en/master/usage/markdown.html}{Sphinx documentation}.
\end{quote}

\sphinxAtStartPar
Install \sphinxcode{\sphinxupquote{myst\sphinxhyphen{}parser}} (\sphinxcode{\sphinxupquote{pip install myst\sphinxhyphen{}parser}}) and then edit \sphinxcode{\sphinxupquote{conf.py}}:
...
\sphinxAtStartPar
I’ve created a small example project \sphinxhref{https://github.com/serra/sphinx-with-markdown}{on Github (serra/sphinx\sphinxhyphen{}with\sphinxhyphen{}markdown)} demonstrating how (and that) it works. It uses Sphinx version 3.5.4 and myst\sphinxhyphen{}parser version 0.14.0.


\section{Pre\sphinxhyphen{}april 2021}
\label{\detokenize{test:pre-april-2021}}
\sphinxAtStartPar
You can use Markdown and reStructuredText in the same Sphinx project. How to do this is succinctly documented on \sphinxhref{http://docs.readthedocs.org/en/latest/getting\_started.html\#in-markdown}{Read The Docs}.

\sphinxAtStartPar
Install recommonmark (\sphinxcode{\sphinxupquote{pip install recommonmark}}) and then edit \sphinxcode{\sphinxupquote{conf.py}}:
...
\sphinxAtStartPar
I’ve created a small example project \sphinxhref{https://github.com/serra/sphinx-with-markdown}{on Github (serra/sphinx\sphinxhyphen{}with\sphinxhyphen{}markdown)} demonstrating how (and that) it works. It uses CommonMark 0.5.4 and recommonmark 0.4.0.
